namespace Domain.Runtime.WorldDomain.World
{
    public class RoomSpatial
    {
            ...
            int chunkX, int chunkY, int cellX, int cellY, int z)
        {
            ...
            layer.Add(entityId, chunkX, chunkY, cellX, cellY);
        }
            ...
            int chunkX, int chunkY, int cellX, int cellY, int z)
        {
            ...
            layer.Remove(entityId, chunkX, chunkY, cellX, cellY);
        }
        ...
        {
            Remove(entityId, oldPos.cx, oldPos.cy, oldPos.x, oldPos.y, oldPos.z);

            Add(entityId, newPos.cx, newPos.cy, newPos.x, newPos.y, newPos.z);
        }
