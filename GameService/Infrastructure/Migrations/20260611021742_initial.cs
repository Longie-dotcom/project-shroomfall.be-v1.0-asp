        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Appearance_SkinColor_H = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    Appearance_SkinColor_S = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    Appearance_SkinColor_V = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    ...
                    Appearance_HairColor_H = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    Appearance_HairColor_S = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    Appearance_HairColor_V = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    Appearance_PantColor_H = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    Appearance_PantColor_S = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    Appearance_PantColor_V = table.Column<float>(type: "real", nullable: true, defaultValue: 0f),
                    ...
                    Collision_OffsetX = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    Collision_OffsetY = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    ...
                    Entrance_OffsetX = table.Column<float>(type: "real", nullable: true),
                    Entrance_OffsetY = table.Column<float>(type: "real", nullable: true),
